...
const Unauthorized: React.FC = () => {
  return (
    <div>
      <Head>
        <title>Unauthorized | NotesApp</title>
      </Head>
      <div style={{
        display: 'flex',
        ...
        <div style={{
          ...
          <ProhibitIcon size={64} weight="bold" color="var(--color-accent-red)" />
        </div>
        <h1 style={{ fontSize: '3rem', fontWeight: 900, marginBottom: '1rem', letterSpacing: '-0.02em' }}>
          Access Denied
        </h1>
        <p style={{ fontSize: '1.2rem', color: 'var(--color-text-muted)', marginBottom: '2rem', maxWidth: '400px' }}>
        ...
        <div style={{ display: 'flex', gap: '1rem' }}>
          ...
          <Link href="/" style={{ textDecoration: 'none' }}>
            <button className="btn-ghost" style={{ padding: '0.75rem 2rem', fontSize: '1rem' }}>
              Home
            </button>
          </Link>
        </div>
